...
l=length(nameFolds);
fid=fopen('./Out_eVU_VU.txt','w');
fprintf(fid,'This is comparision of eVUl1 version 2.0 and VUl1 v2.0 for 46 problems to be reported to Foz2018. ');
