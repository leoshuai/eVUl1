% Based on the file demo_spikes_high_tau.m in SpaRSA_2.0.
% Just added the algorithm eVUl1 to the solvers
clc
clear
...
%
quiet=1;
[x_l1_ls,status,history] = l1_ls(R,y,2*tau,1.e-3,quiet);
...
telapsed = toc(tstart);
fprintf(1,'fv=%e, cpu=%f\n',fv,telapsed+  telapsed0);
